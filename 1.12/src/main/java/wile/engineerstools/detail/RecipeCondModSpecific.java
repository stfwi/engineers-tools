 ...
 * in assets/engineerstools/recipes/_factories.json with full path (therefore
  ...
  public BooleanSupplier parse(JsonContext context, JsonObject json) {
    ...
    try {
      ...
      if(result != null) {
        ...
        if(ModConfig.isOptedOut(item_registry.getValue(rl))) return exclude(); // disabled in mod config
      }
