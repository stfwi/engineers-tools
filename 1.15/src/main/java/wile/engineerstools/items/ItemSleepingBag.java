...
public class ItemSleepingBag extends ItemTools
{
  ...
  public void inventoryTick(ItemStack stack, World world, Entity entity, int itemSlot, boolean isSelected)
  {
    ...
    if((pos == null) || (dim != player.dimension) || (dim==null)) return;
    if(!((ItemSleepingBag)player.getHeldItem(Hand.MAIN_HAND).getItem()).respawn_at_bed) player.setSpawnPoint(pos, true, false, dim);
  }
