...
public class Networking
{
  ...
  public static class PacketContainerSyncServerToClient
  {
    ...
    public static void sendToPlayer(PlayerEntity player, Container uicontainer, CompoundNBT nbt)
    {
      if((!(player instanceof ServerPlayerEntity)) || (player instanceof FakePlayer) || (nbt==null)) return;
      DEFAULT_CHANNEL.sendTo(new PacketContainerSyncServerToClient(uicontainer.containerId, nbt), ((ServerPlayerEntity)player).connection.connection, NetworkDirection.PLAY_TO_CLIENT);
    }
